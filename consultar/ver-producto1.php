    ...
    <article id="contenido" class="col-sm-12 col-md-12  col-lg-12">
      <div class="panel panel-primary">
        <div class="panel-heading">
          <label for="usuario" id="panel"><span class="glyphicon glyphicon-search"></span> CONSULTAS RELACIONADAS CON LOS PRODUCTOS </label>
        </div>
        <div class="panel-body">
          <!-- Lista de tags que se ven por defecto aparece el primero -->
          <ul class="nav nav-tabs">
          <li class="active"><a id="btn-secundario" data-toggle="tab" href="#home"><span class="glyphicon glyphicon-eye-close"></span> PRODUCTO</a></li>
        </ul>

        <!-- contenido de cada tag -->
        <div class="tab-content">
          <div id="home" class="tab-pane fade in active">
            <h3 id="btn-secundario">PRODUCTOS REGISTRADOS</h3>
            <?php include("consultar-producto.php"); ?>
          </div>
        </div>
        </div>
      </div>
