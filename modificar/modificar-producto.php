...
@header("Content-Type: text/html;charset=iso-8859-1");
  ...
  if (isset($_POST['txtdescripcion'])) {
    ...
    $bd->modificar("productos", "Descripcion = '$Descripcion', Precio = '$precio', Id_Categoria = '$idcategoria', Id_Proveedor = '$idproveedor'", "Id_producto = $id", "../consultar/ver-producto.php");
  }
      ...
      <div class="container">
        <section class="main row">
          ...
          <div class="panel-heading">
            <label for="usuario" id="panel"><span class="glyphicon glyphicon-eye-close"></span> FORMULARIO PARA MODIFICAR PRODUCTOS</label>
          </div>
          ...
          <form action="modificar-producto.php" method="post">
            <div class="form-group row">
                ...
                <div class="col-10">
                  <input class="form-control" name="txtdescripcion" type="text" id="example-text-input" value="<?php $bd-> mostrarValor('Descripcion', 'productos', 'Id_producto', $id); ?>" required onkeypress="return sololetras(event)" onpaste="return false">
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-10">
                  <input class="form-control" name="txtprecio" type="text" id="example-text-input" value="<?php $bd-> mostrarValor('Precio', 'productos', 'Id_producto', $id); ?>" required onkeypress="return solonumeros(event)" onpaste="return false">
                </div>
                <input type="hidden" name="txtid" value="<?php echo $id; ?>"/>
            </div>
            <div class="form-group row">
                ...
                <div class="col-10">
                  <?php
                     $bd->generarListaEspecifica("Id_Categoria", "descripcion", "categorias", "(SELECT Id_Categoria FROM productos WHERE Id_Producto = '$id')","form-control","selcategoria","selcategoria");
                  ?>
                </div>
                <input type="hidden" name="txtid" value="<?php echo $id; ?>"/>
            </div>
            <div class="form-group row">
                ...
                <div class="col-10">
                  <?php
                     $bd->generarListaEspecifica("Id_Proveedor", "Nombre", "proveedores", "(SELECT Id_Proveedor FROM productos WHERE Id_Producto = '$id')","form-control","selproveedor","selproveedor");
                  ?>
                </div>
                <input type="hidden" name="txtid" value="<?php echo $id; ?>"/>
            </div>
